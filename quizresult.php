...
<div class="col-md-3">
  <input class="radios" type="radio" disabled="true" 
         <?php echo (isset($ans) && $ans->Answer == $res->ChoiceA) ? 'CHECKED' : ''; ?>> 
  A. <?php echo $res->ChoiceA; ?>
</div>

<div class="col-md-3">
  <input class="radios" type="radio" disabled="true" 
         <?php echo (isset($ans) && $ans->Answer == $res->ChoiceB) ? 'CHECKED' : ''; ?>> 
  B. <?php echo $res->ChoiceB; ?>
</div>

<div class="col-md-3">
  <input class="radios" type="radio" disabled="true" 
         <?php echo (isset($ans) && $ans->Answer == $res->ChoiceC) ? 'CHECKED' : ''; ?>> 
  C. <?php echo $res->ChoiceC; ?>
</div>

<div class="col-md-3">
  <input class="radios" type="radio" disabled="true" 
         <?php echo (isset($ans) && $ans->Answer == $res->ChoiceD) ? 'CHECKED' : ''; ?>> 
